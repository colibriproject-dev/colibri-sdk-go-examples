...
type StudentDBRepository struct{}

func NewStudentDBRepository() *StudentDBRepository {
	return &StudentDBRepository{}
}

func (r *StudentDBRepository) FindAll(ctx context.Context, params *models.StudentParams) ([]models.Student, error) {
	if params.Name != "" {
...
func (r *StudentDBRepository) FindById(ctx context.Context, id uuid.UUID) (*models.Student, error) {
...
func (r *StudentDBRepository) Insert(ctx context.Context, model *models.StudentCreateUpdateDTO) error {
...
func (r *StudentDBRepository) Update(ctx context.Context, id uuid.UUID, model *models.StudentCreateUpdateDTO) error {
...
func (r *StudentDBRepository) Delete(ctx context.Context, id uuid.UUID) error {
	return sqlDB.NewStatement(ctx, `DELETE FROM students WHERE id=$1`, id).Execute()
}

func (r *StudentDBRepository) UploadDocument(ctx context.Context, id uuid.UUID, file *multipart.File) (string, error) {
